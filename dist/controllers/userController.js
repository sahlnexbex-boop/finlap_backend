...
const sendPasswordResetEmail = async (toEmail, otp) => {
    ...
    const hasLogoFile = fs_1.default.existsSync(logoPath);
                ...
                <tr>
                  <td align="center">
                    <div style="background: linear-gradient(135deg, #7C3AED 0%, #8B5CF6 100%); border-radius: 20px; padding: 22px 36px; display: inline-block; box-shadow: 0 10px 28px rgba(124, 58, 237, 0.35); text-align: center; border: 1px solid rgba(255, 255, 255, 0.2);">
                      <div style="color: #FFFFFF; font-size: 38px; font-weight: 800; letter-spacing: 14px; font-family: 'Courier New', Courier, monospace; display: block; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.25);">
                        ${otp}
                      </div>
                    </div>
                  </td>
